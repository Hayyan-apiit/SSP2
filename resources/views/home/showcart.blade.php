                ...
                <tbody>
                  <tr>
                    <td class="product-thumbnail">
                      <img src="/add_garment/{{ $item->image }}" class="img-fluid">
                    </td>
                    <td class="product-name">
                      <h2 class="h5 text-black">{{ $item->store_title }}</h2>
                    </td>
                    <td>Rs:{{ $item->price }}</td>
                    <td>
                    ...
                    <td><a onclick="return confirm('are you sure')" href="{{ url('remove_cart', $cart->first()->id) }}
              ...
              <div class="col-md-7">
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-md-6 text-right">
                    <strong class="text-black">Rs:{{$totalprice}}.00</strong>
                  </div>
                </div>
                <div class="row mb-5">
                  <div class="col-md-6">
                ...
                <div class="row">
                  <div class="col-md-12">
                  <button class="btn btn-success btn-lg py-3 btn-block" onclick="window.location.href='{{ url('add_order') }}'">Proceed To Checkout</button>
                  <button class="btn btn-primary btn-lg py-3 btn-block" onclick="window.location.href='{{ url('stripe/' . $totalprice) }}'">Bank Payment</button>
